...
const DEFAULT_USERNAME_REGISTRY =
  "0x1d8050eda109364c15db4c2c5a172128eaeabd25" as const;
const DEFAULT_GROUP_REGISTRY =
  "0x3d8ea5b32dda2b3bfb71c9a07de25ecf28b73fd4" as const;
const DEFAULT_COWRYPAY =
  "0xf253dde47ca717737be3aefb76326180c2239e04" as const;

export const userRegistryContract = {
  abi: userRegistry,
  address: contractAddress(
    "USERNAME_REGISTRY_ADDRESS",
    DEFAULT_USERNAME_REGISTRY,
  ),
};
